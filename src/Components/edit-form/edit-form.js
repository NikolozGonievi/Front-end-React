...
const ChangeCar = (props) => {
    ...
    ChangeCar.propTypes = {
        ...
        handleChangeCar: propTypes.func.isRequired,
        handleChangeFormClose: propTypes.func.isRequired,
    ...
    /*
    მოვლენა, რომლის დამუშავების დროს ხდება შესაბამისი მანქანის შეცვლა სერვერზა და state-ში
    */
    const onSubmit = data => {
